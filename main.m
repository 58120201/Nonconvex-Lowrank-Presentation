...
% LAMBDA = [5e-3 1e-2 1e-1 1];
% OA=[];
% Kappa=[];
% for i = 1:length(LAMBDA)
%         tic
%          [Lhat,Shat] = trpca_explr_plus(T_real,LAMBDA(i),opts);
%         time = toc;
%         [OA_SVM1, OA_SVM2, AA_SVM1, AA_SVM2, Kappa_SVM1, Kappa_SVM2,ave_TPR_SVM1,ave_TPR_SVM2] = Classification_V2(T_real,Lhat,gt,3,CTrain);
%         OA = [OA, OA_SVM2];
%         Kappa = [Kappa,Kappa_SVM2];
% end
% OA

tic
% [TRec,  S] = trpca_explr(T, lambda,opts);
[TRec,  S] = trpca_explr_plus(T_real, lambda,opts);
time = toc;
%% classification
%[OA_SVM1, OA_SVM2, AA_SVM1, AA_SVM2, Kappa_SVM1, Kappa_SVM2,ave_TPR_SVM1,ave_TPR_SVM2] = Classification_V2(T_real,T,gt,10,CTrain);
[OA_SVM1, OA_SVM3, AA_SVM1, AA_SVM3, Kappa_SVM1, Kappa_SVM3,ave_TPR_SVM1,ave_TPR_SVM3] = Classification_V2(T_real,TRec,gt,10,CTrain);
