function [OA_SVM1, OA_SVM2, AA_SVM1, AA_SVM2, ave_Kappa_SVM1, ave_Kappa_SVM2,ave_TPR_SVM1,ave_TPR_SVM2] = Classification_V2(org_data,re_data,GT_map,iter,CTrain)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%CTrain=[23 89 73 66 71 81 14 71 10 76 112 68 67 89 68 47];%% for indian pines dataset
...
% ave_accracy_SVMCK1=mean(accracy_SVMCK1);
% ave_Kappa_SVMCK1=mean(Kappa_SVMCK1);
% ave_TPR_SVMCK1=mean(TPR_SVMCK1);
% ave_accracy_SVMCK2=mean(accracy_SVMCK2);
